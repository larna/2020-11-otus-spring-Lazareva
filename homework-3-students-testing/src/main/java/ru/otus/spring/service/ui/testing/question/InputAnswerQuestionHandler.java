...
public class InputAnswerQuestionHandler extends BaseAskQuestionHandler {
    ...
    private static final String INPUT_ANSWER_MESSAGE = "testProcess_answerInput";

    @Autowired
    public InputAnswerQuestionHandler(IOService ioService, LocalizationService localizationService) {
        super(ioService, localizationService, INPUT_ANSWER_MESSAGE);
    }
