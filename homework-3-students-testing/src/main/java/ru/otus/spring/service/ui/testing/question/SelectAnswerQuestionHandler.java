...
public class SelectAnswerQuestionHandler extends BaseAskQuestionHandler {
    ...
    private static final String SELECT_ANSWER_MESSAGE = "testProcess_answerSelect";
    private static final String ANSWER_INVITE_REPEAT_SELECT_MESSAGE = "testProcess_answerRepeatSelect";

    @Autowired
    public SelectAnswerQuestionHandler(IOService ioService, LocalizationService localizationService) {
        super(ioService, localizationService, SELECT_ANSWER_MESSAGE);
    }
    ...
    public Answer askQuestion(Integer counter, Question question) throws InputAnswerException {
        ...
        try {
            ...
            String answerRepeatMessage = localizationService.getMessage(ANSWER_INVITE_REPEAT_SELECT_MESSAGE);
