...
public class TestServiceImpl implements TestService {
    ...
    private final Integer testPassPercent;

    @Autowired
    public TestServiceImpl(QuestionService questionService,
                           TestDao dao,
                           @Value("${test.pass.percent}") Integer testPassPercent) {
        this.questionService = questionService;
        this.dao = dao;
        this.testPassPercent = testPassPercent;
    }
    ...
    public TestResultsReport getTestResults(StudentTest test) {
        boolean isFailed = test.getFactPercentPassTest() < testPassPercent;
