...
class BookServiceImplTest {
    ...
    @BeforeEach
    void setUp() {
        bookService = new BookServiceImpl(bookRepository, commentRepository);
    }
    ...
    void shouldUpdateBookName() {
        ...
        Mockito.verify(bookRepository, Mockito.times(1)).existsById(eq(bookId));
        Mockito.verify(bookRepository, Mockito.times(1)).updateBookName(eq(bookId),eq(expectedNewBookName));
    }
    ...
    void shouldThrowExceptionForUpdateBookNameIfBookNotExists() {
        ...
        Mockito.when(bookRepository.existsById(bookId)).thenThrow(BookNotFoundException.class);

        assertThrows(BookNotFoundException.class, () -> bookService.updateBookName(bookId, "Новое название"));
        Mockito.verify(bookRepository, Mockito.times(1)).existsById(eq(bookId));
        Mockito.verify(bookRepository, Mockito.times(0)).updateBookName(any(), any());
        Mockito.verify(bookRepository, Mockito.times(0)).findBookById(eq(bookId));
    }
    ...
    void shouldInvokeDeleteOfRepository() {
        ...
        Mockito.verify(bookRepository, Mockito.times(1)).existsById(eq(bookId));
        Mockito.verify(bookRepository, Mockito.times(1)).deleteById(eq(bookId));
    }
    ...
    void shouldThrowExceptionForDeleteIfBookNotExists() {
        ...
        Mockito.verify(bookRepository, Mockito.times(1)).existsById(eq(bookId));
        Mockito.verify(bookRepository, Mockito.times(0)).deleteById(eq(bookId));
    }
    ...
    void shouldInvokeGetByIdOfRepository() {
        ...
        Mockito.verify(bookRepository, Mockito.times(1)).existsById(eq(bookId));
        Mockito.verify(bookRepository, Mockito.times(1)).findBookById(eq(bookId));
    }
    ...
    void shouldInvokeGetByIsbnOfRepository() {
        ...
        Mockito.verify(bookRepository, Mockito.times(1)).existsBookByIsbn(eq(isbn));
        Mockito.verify(bookRepository, Mockito.times(1)).findBookByIsbn(eq(isbn));
    }
    ...
    void shouldThrowExceptionForFindByIsbnIfBookNotExists() {
        final String isbn = "ISBN-1234";
        Mockito.when(bookRepository.existsBookByIsbn(isbn)).thenReturn(false);

        assertThrows(BookNotFoundException.class, () -> bookService.findByIsbn(isbn));
        Mockito.verify(bookRepository, Mockito.times(1)).existsBookByIsbn(eq(isbn));
        Mockito.verify(bookRepository, Mockito.times(0)).findBookByIsbn(eq(isbn));
    }
    ...
    void shouldInvokeGetByAuthorOfRepository() {
        ...
        Mockito.verify(bookRepository, Mockito.times(1)).findAllByAuthorsIs(any());
    }
    ...
    void shouldInvokeGetByGenreOfRepository() {
        ...
        Mockito.verify(bookRepository, Mockito.times(1)).findAllByGenre(any());
    }
    ...
    void shouldInvokeGetAllWithFilter() {
        ...
        Mockito.verify(bookRepository, Mockito.times(1)).findAll((Specification) any(), (Pageable) any());
    }
}